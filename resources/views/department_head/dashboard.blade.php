    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="flex-1 overflow-y-auto bg-[#F3EEE0]">
            ...
            <div class="p-8">
                ...
                <!-- Quick Actions -->
                <div class="mb-8">
                    <a href="{{ route('department_head.request-asset') }}" class="submit-btn bg-[#C9A227] text-[#0A1830] px-6 py-3 rounded-lg hover:bg-[#E9C766] transition-all inline-flex items-center shadow-md font-semibold">
