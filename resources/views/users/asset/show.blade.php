...
<body class="bg-gray-50">
    ...
    <div class="max-w-4xl mx-auto p-8">
        ...
        {{-- Back Button --}}
        <a href="/users/assets" class="inline-flex items-center gap-1.5 text-sm text-gray-500 px-3 py-1.5 rounded-lg border border-gray-200 bg-gray-100 hover:bg-gray-200 transition mb-5">
